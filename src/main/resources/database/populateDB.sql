...
INSERT INTO users (id, username, password, email) VALUES
  ...
  (uuid_in(md5(random()::text || now()::text)::cstring), 'admin_test', '$2a$10$rJTv8Vgz5bTVPj6xyYiqVeH6ULD..kHEKBFcgluYeuODXNkyhYXxy','admin_test@example.com')
;
...
INSERT INTO user_roles (user_id, role_id)
 SELECT u.id AS user_id, r.id AS role_id FROM users u, roles r WHERE u.username = 'admin_test'  AND r.name = 'ROLE_ADMIN';
INSERT INTO user_roles (user_id, role_id)
